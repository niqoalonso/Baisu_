                                        ...
                                        <div class="row">  
                                            ...
                                            <div class="col-lg-4 mt-2">
                                                <div class="form-check">
                                                    <input type="checkbox" name="permission[]" class="form-check-input" value="{{$item->name}}" id="formCheck{{$key}}">
                                        ...
                                        <div class="row">   
                                            <div class="col-lg-12">
                                                <div class="d-flex flex-wrap gap-3 mt-3 justify-content-end">
                                                    <button type="submit" class="btn btn-primary waves-effect waves-light w-md"><i class="mdi mdi-content-save"></i> Crear</button>
                                                    <a href="{{route('roles-permisos.index')}}"><button type="button" class="btn btn-outline-danger waves-effect waves-light w-md"><i class="mdi mdi-close"></i> Cancelar</button></a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
